...
{
    public class PipeRunAnalysis_OBSOLETE2403 : GH_AsyncComponent
    {
        public PipeRunAnalysis_OBSOLETE2403() : base("FEM-Design.RunAnalysis", "RunAnalysis", "Run analysis of model.\nDO NOT USE THE COMPONENT IF YOU WANT TO PERFORM ITERATIVE ANALYSIS (i.e. Galapos)", CategoryName.Name(), SubCategoryName.Cat8())
        {
