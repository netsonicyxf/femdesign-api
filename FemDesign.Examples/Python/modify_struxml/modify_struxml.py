...
def main():
    ...
    database.country = Eurocodetype.S
    database.entities.supports.point_support[0].group.rigidity.motions.x_neg = 0
    database.entities.supports.point_support[0].group.rigidity.motions.x_pos = 0
