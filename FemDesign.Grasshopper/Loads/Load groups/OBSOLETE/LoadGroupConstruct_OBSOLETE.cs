...
{
    public class LoadGroupConstruct_OBSOLETE : FEM_Design_API_Component
    {
        public LoadGroupConstruct_OBSOLETE() : base("LoadGroup.Construct", "Construct", "Construct a load group.", CategoryName.Name(), SubCategoryName.Cat3())
        {
