...
namespace FemDesign.Drawing
{
    ...
    public class DimensionLinearTest
    {
        ...
        {
            var p0 = new FemDesign.Geometry.Point3d(0, 0, 0);
            var p1 = new FemDesign.Geometry.Point3d(1, 1, 5);
            var p2 = new FemDesign.Geometry.Point3d(3, 3, 7);
            var refPoints = new List<FemDesign.Geometry.Point3d> { p0, p1, p2 };
            
            // 1
            var plane = new Plane(FemDesign.Geometry.Point3d.Origin, new Vector3d(1, 1, 0), new Vector3d(-1, 1, 0));
            ...
            // 2
            plane = new Plane(FemDesign.Geometry.Point3d.Origin, new Vector3d(1, 1, 1), new Vector3d(-1, 1, 0));
